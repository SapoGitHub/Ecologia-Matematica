...
* [Laguna-2015(2-especies)](https://fiscomp.if.ufrgs.br/index.php/Modelo_de_Levins_aprimorado_para_2_esp%C3%A9cies).py: Solução numérica para as equações diferenciais para 2 espécies
...
* [Laguna-2019(Rede_media2)](https://fiscomp.if.ufrgs.br/index.php/Simula%C3%A7%C3%A3o_e_modelo_de_campo_m%C3%A9dio)y: Simulação 2 baseada nos modelos de campo médio 
